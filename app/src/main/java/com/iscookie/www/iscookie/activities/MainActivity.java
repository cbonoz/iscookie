...
public class MainActivity extends CameraActivity implements OnImageAvailableListener, ConfettiActivity {
...
//                        resultsView.setResults(results);
    ...
    // Update the screen based on whether the image is probabilistically a cookie or not.
